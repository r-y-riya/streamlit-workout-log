...
def get_video_url(exercise_name):
    ...
    return video_mapping.get(exercise_name, "https://www.youtube.com/watch?v=default_video")
...
def load_exercises_from_json():
    try:
        ...
        st.error("exercises.json file not found. Please make sure it exists in the same directory as this script.")
        return []
